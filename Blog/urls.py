...
urlpatterns = [
    ...
    path('category/case_studies/<name3>/', views.category_business_detailview, name='business_detailview'),
    path('category/case_studies/<name3>/', views.category_personal_detailview, name='personal_detailview'),
    path('cybersecurity-case-studies/', views.cybersecurity_case_studies, name='cyber-category'),
